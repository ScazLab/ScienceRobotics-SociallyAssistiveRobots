...
namespace HouseGame
{
    ...
    public class ConstructedHouseTutorial
    {
        ...
        public ConstructedHouseTutorial()
        {

        }

        public ConstructedHouseTutorial(int numWallPieces, int numRoofPieces, int numPlantPieces, int numDoorPieces)
        {
    ...
    public class ChildBuilderTutorial : MonoBehaviour
    {
        ...
        public void FinishBuilding()
        {
            ...
            if (gameController.tutorial)
            {
                SceneManager.LoadScene("Robot_guessing_tutorial");
            }
            else
            {
        ...
        public bool IsHouseComplete()
        {
            if (gameController.tutorial)
            {
                if ((explainerHouse.n_wall_pieces == 4) && (explainerHouse.n_roof_pieces == 1) && (explainerHouse.n_door_pieces == 2))
                {
                    return true;
                }
            }
        ...
        void PanelIn()
        {
            ...
            else if (lastPieceTypeSelected == Constants.DOOR)
            {
                ...
                if (gameController.tutorial)
                {
                    GameObject d1 = GameObject.Find("arrows_door1");
                    d1.gameObject.GetComponent<Renderer>().enabled = false;
                    GameObject d2 = GameObject.Find("arrows_door2");
                    d2.gameObject.GetComponent<Renderer>().enabled = false;
                }
            }
            ...
            if (currentPieceTypeSelected == Constants.WALL)
            {
                ...
                if (gameController.tutorial)
                {
                    gameController.SendRobotUtterance("child-building-tutorial-2", true, -1, -1, -1);
                    GameObject w = GameObject.Find("arrow_wall");
                    w.gameObject.GetComponent<Renderer>().enabled = true;
                }
            }
            else if (currentPieceTypeSelected == Constants.ROOF)
            {
                gameController.SendRobotUtterance("child-building-tutorial-5", true, -1, -1, -1);
                ShowSelectedRoofPieces();
            ...
            else if (currentPieceTypeSelected == Constants.DOOR)
            {
                ...
                if (gameController.tutorial)
                {
                    gameController.SendRobotUtterance("child-building-tutorial-9", true, -1, -1, -1);
                    GameObject d1 = GameObject.Find("arrows_door1");
                    d1.gameObject.GetComponent<Renderer>().enabled = true;
                    GameObject d2 = GameObject.Find("arrows_door2");
                    d2.gameObject.GetComponent<Renderer>().enabled = true;
                }
            }
        ...
        {
            if (((tutorial_step == 0) && (selectedOutlineType == Constants.WALL)) ||
               ((tutorial_step == 2) && (selectedOutlineType == Constants.ROOF)) ||
               ((tutorial_step == 5) && (selectedOutlineType == Constants.DOOR)))
        ...
        void tutorial2()
        {
            ...
            // tell child that walls have to be same type.

            // Show child how to use garbage

            // Trash wall piece and add other wall piece
